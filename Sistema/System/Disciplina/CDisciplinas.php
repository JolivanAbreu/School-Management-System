...
<body>
    ...
    <div class="Cadastro">
        <section id="Turmas">
            <h2 class="HTurmas"><i class="fas fa-chalkboard"></i> Cadastro de Disciplinas</h2>
            <form method="post" id="turmaForm" class="FormTurmas" action="../../php/Turma/CTurma.php">
                ...
                <label for="disciplinaNome" class="LabelTurmas">Descrição</label>
                <input type="text" name="descricao" id="disciplinaNome" class="InputTurmas" required>
